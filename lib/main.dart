...
import 'package:prime_template/features/authentication/views/onboarding_screen.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return StateManagementClass(
      child: MaterialApp(
          title: 'Peoples Operation Assessment',
          theme: ThemeData(
            ...
            primaryColor: Color(0xff31A062),
            colorScheme: ColorScheme.fromSeed(seedColor: Color(0xff31A062)),
            useMaterial3: true,
          ),
